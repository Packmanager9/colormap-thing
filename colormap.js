...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    function main() {
        ...
        for (let g = 0; colors.length > g; g++) {
            if(typeof colors[g][0] != "undefined"){
                if(hash[`${colors[g][0]},${colors[g][1]},${colors[g][2]}`]){
                    hash[`${colors[g][0]},${colors[g][1]},${colors[g][2]}`]++
                    hash[`${colors[g][0]},${colors[g][1]},${colors[g][2]}`]*=.99
                }else{
                    hash[`${colors[g][0]},${colors[g][1]},${colors[g][2]}`] = 1
                }
            }
        }
        let bunker = 0
